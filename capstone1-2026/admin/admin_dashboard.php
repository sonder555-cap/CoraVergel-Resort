                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php else: ?>
                                    <span class="status-badge status--confirmed"><?=$rm['booked_today']?>/<?=$rm['total_units']?> reserved</span>
                                <?php endif; ?>
                                <?php if($rm['pending_today'] > 0): ?>
                                <div style="font-size:10px;color:#e65100;margin-top:3px;">
                                    <i class="fa-solid fa-clock" style="font-size:9px;"></i> <?=$rm['confirmed_today']?> confirmed, <?=$rm['pending_today']?> pending
                                </div>
                                <?php endif; ?>
                            </td>
                            <td>
