...
<form method="POST" action="admin_dashboard.php" enctype="multipart/form-data" id="addRoomForm">
    ...
    <div class="bmodal-body">
        ...
        <div class="bmodal-fields">
            ...
            <div class="bmodal-field">
                <div class="bmodal-field-lbl">Capacity (pax)</div>
                <input type="number" name="capacity" min="1" value="4" required
                    style="width:100%;border:none;background:transparent;font-size:14px;font-weight:600;color:#1a1a2e;outline:none;">
            </div>
        </div>
        <div class="bmodal-fields" style="margin-top:8px;">
            <div class="bmodal-field">
                <div class="bmodal-field-lbl">Badge</div>
                <select name="badge" style="width:100%;border:none;background:transparent;font-size:13px;font-weight:600;color:#1a1a2e;outline:none;">
            ...
            <div class="bmodal-field" style="grid-column:span 2;">
                <div class="bmodal-field-lbl">Tags (comma-separated)</div>
                <input type="text" name="tags" placeholder="Free Entrance, Balcony, Air Conditioned"
                    style="width:100%;border:none;background:transparent;font-size:13px;color:#1a1a2e;outline:none;">
            </div>
        </div>
        ...
        <div class="bmodal-field" style="margin-top:8px;">
            <div class="bmodal-field-lbl">Room Photos</div>
            <div class="photo-drop-zone" id="addPhotoDropZone" onclick="document.getElementById('addRoomFileInput').click()">
                <i class="fa-solid fa-cloud-arrow-up"></i>
                <div class="pdz-title">Click to upload photos</div>
                <div class="pdz-sub">JPG, PNG, or WEBP · max 5MB each · up to 5 photos</div>
            </div>
            ...
            <div class="photo-thumb-grid" id="addPhotoThumbs"></div>
            <div class="photo-count-pill" id="addPhotoCount"></div>
        </div>
    </div>
...
<form method="POST" action="admin_dashboard.php" enctype="multipart/form-data" id="editRoomForm">
    ...
    <div class="bmodal-body">
        ...
        <div class="bmodal-fields" style="margin-top:8px;">
            <div class="bmodal-field">
                <div class="bmodal-field-lbl">Badge</div>
                <select name="badge" id="er-badge" style="width:100%;border:none;background:transparent;font-size:13px;font-weight:600;color:#1a1a2e;outline:none;">
                    <option>Available</option>
                    <option>Popular</option>
                    <option>New</option>
                    <option>Limited</option>
        ...
        <div class="bmodal-field" style="margin-top:8px;">
            <div class="bmodal-field-lbl">Description</div>
            <textarea name="description" id="er-description" rows="3"
                style="width:100%;border:none;background:transparent;font-size:13px;color:#1a1a2e;outline:none;font-family:inherit;resize:vertical;"></textarea>
        </div>
        <div class="bmodal-field" style="margin-top:8px;">
            <div class="bmodal-field-lbl">Current Photos</div>
            <div class="photo-thumb-grid" id="er-existing-photos"></div>
            <div id="er-no-photos" style="font-size:12px;color:#aaa;margin:6px 0;">No photos uploaded yet.</div>

            <div class="photo-drop-zone" id="editPhotoDropZone" style="margin-top:10px;" onclick="document.getElementById('editRoomFileInput').click()">
                <i class="fa-solid fa-cloud-arrow-up"></i>
                <div class="pdz-title">Upload new photos</div>
                <div class="pdz-sub">Uploading replaces all current photos · up to 5</div>
            </div>
            ...
            <div class="photo-thumb-grid" id="editPhotoThumbs"></div>
            <div class="photo-count-pill" id="editPhotoCount"></div>
        </div>
        <p style="font-size:11px;color:#aaa;margin-top:10px;">Room name can't be changed here — delete and re-add if you need to rename it.</p>
    </div>
    <div class="bmodal-footer" style="display:flex;gap:10px;">
    ...
    files.forEach((file, idx) => {
        ...
        reader.onload = e => {
            ...
            item.innerHTML = '<img src="' + e.target.result + '" alt="">' +
                '<button type="button" class="photo-thumb-remove" onclick="removePhoto(event,\'' + prefix + '\',' + idx + ')"><i class="fa-solid fa-xmark"></i></button>';
...
function openEditRoomModal(id,name,price,units,description,imageUrl,galleryUrls,capacity,badge,tags){
    ...
    if (allPhotos.length) {
        grid.innerHTML = allPhotos.map(url => '<div class="photo-thumb-existing"><img src="' + url + '" alt=""></div>').join('');
