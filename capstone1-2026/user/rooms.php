...
.search-bar-container_inner {
    ...
    z-index: 200;
    background: #fff;
    padding: 20px 32px;    /* was 20px 32px */
    max-width: 780px;      /* was 550px */
}
    ...
    #dbGuestVal, #dbCheckInVal, #dbCheckOutVal { color: var(--black); font-weight: 700;}
    .g-sub { font-size: .78rem; color: #999; margin-top: 2px; }



    /* ── Guests popup: card look matching reference ── */
...
.search-bar-container_checkOut:hover {
    ...
    @media (max-width: 760px) {
        .resort-hero { height: 320px; }
        .resort-hero-info { padding: 22px 20px; }
        .resort-hero-details { flex-direction: column; gap: 6px; }
    }
    </style>
</head>
<body>
