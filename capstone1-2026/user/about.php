...
<section class="about-section" style="padding-top:64px;padding-bottom:64px;">
    <div style="text-align:center;">
        <div class="section-eyebrow" style="justify-content:center;">Explore the Grounds</div>
        <h2 class="section-title" style="text-align:center;">Find Your Way<br><em>Around the Resort</em></h2>
        <p class="section-body" style="text-align:center;max-width:600px;margin:0 auto;">
            From the pools to the bahay kubo &mdash; here's where everything sits across the property,
            so you can plan your stay before you even arrive.
        </p>
    </div>

    <div class="map-card">
        <div class="map-img-wrap">
            <img src="../assets/images/resort-map.png" alt="CoraVergel Resort layout map">
        </div>
    </div>
</section>
...
<style>
    ...
    /* Resort map — narrower card, image at its own natural proportions.
       No forced box shape, so no empty space and nothing to fill.
       Move this into user.css once you're happy with it; kept inline here for now. */
    .map-card {
        display: flex;
