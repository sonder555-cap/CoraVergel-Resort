...
<div class="gallery-wrap">
    ...
    <section class="gal-section" id="pool-playground">
        <div class="gal-section-head">
            ...
            <div class="gal-section-count">6 Photographs</div>
        </div>
        ...
        <div class="gal-masonry gal-block">
            <div class="gal-tile"
                ...
                <div class="gal-tile-overlay">
                    ...
                    <div class="gal-tile-cat">Pool &amp; Playground</div>
                </div>
            ...
            <div class="gal-tile"
                ...
                <div class="gal-tile-overlay">
                    <div class="gal-tile-label">Poolside Grounds</div>
                    <div class="gal-tile-cat">Pool &amp; Playground</div>
                </div>
                <div class="gal-tile-expand"><i class="fa-solid fa-expand"></i></div>
            </div>
    ...
    <section class="gal-section" id="coffee-billiard">
        <div class="gal-section-head">
            ...
            <div class="gal-section-count">Coming Soon</div>
        </div>

        <div class="gal-masonry gal-block">
            <div class="gal-placeholder-tile">
    ...
    <section class="gal-section" id="rooms-cottages">
        ...
        <div class="gal-masonry gal-block">
            ...
            <div class="gal-tile"
                ...
                <div class="gal-tile-overlay">
                    <div class="gal-tile-label">Bahay Kubo Interior</div>
                    <div class="gal-tile-cat">Rooms &amp; Cottages</div>
                </div>
                <div class="gal-tile-expand"><i class="fa-solid fa-expand"></i></div>
            </div>
            <div class="gal-tile"
                ...
                <div class="gal-tile-overlay">
                    <div class="gal-tile-label">Duplex Room Interior</div>
                    <div class="gal-tile-cat">Rooms &amp; Cottages</div>
                </div>
                <div class="gal-tile-expand"><i class="fa-solid fa-expand"></i></div>
            </div>
            <div class="gal-tile"
                ...
                <div class="gal-tile-overlay">
                    <div class="gal-tile-label">Family Room, Bunk Beds</div>
                    <div class="gal-tile-cat">Rooms &amp; Cottages</div>
                </div>
                <div class="gal-tile-expand"><i class="fa-solid fa-expand"></i></div>
            </div>
            <div class="gal-tile"
                ...
                <div class="gal-tile-overlay">
                    <div class="gal-tile-label">Bahay Kubo Bedding</div>
                    <div class="gal-tile-cat">Rooms &amp; Cottages</div>
                </div>
                <div class="gal-tile-expand"><i class="fa-solid fa-expand"></i></div>
            </div>
    ...
    <section class="gal-section" id="pavilions">
        ...
        <div class="gal-masonry gal-block">
            <div class="gal-tile"
                ...
                <div class="gal-tile-overlay">
                    <div class="gal-tile-label">Kubo Bulawan Pavilion</div>
                    <div class="gal-tile-cat">Pavilions &amp; Gathering Spaces</div>
                </div>
                <div class="gal-tile-expand"><i class="fa-solid fa-expand"></i></div>
            </div>
            <div class="gal-tile"
                 data-src="../assets/images/kubo-area-hall.jpg"
                 data-caption="Kubo Area Dining Hall"
                 onclick="openLb(this)">
                <img src="../assets/images/kubo-area-hall.jpg" alt="Kubo Area Dining Hall">
                <div class="gal-tile-overlay">
                    <div class="gal-tile-label">Kubo Area Dining Hall</div>
                    <div class="gal-tile-cat">Pavilions &amp; Gathering Spaces</div>
                </div>
                <div class="gal-tile-expand"><i class="fa-solid fa-expand"></i></div>
            </div>
            <div class="gal-tile"
                 data-src="../assets/images/family-hall-event.jpg"
                 data-caption="Family Hall Function Room"
                 onclick="openLb(this)">
                <img src="../assets/images/family-hall-event.jpg" alt="Family Hall Function Room">
                <div class="gal-tile-overlay">
                    <div class="gal-tile-label">Family Hall Function Room</div>
                    <div class="gal-tile-cat">Pavilions &amp; Gathering Spaces</div>
                </div>
                <div class="gal-tile-expand"><i class="fa-solid fa-expand"></i></div>
            </div>
            <div class="gal-tile"
                 data-src="../assets/images/poolside-pavilion.jpg"
                 data-caption="Poolside Pavilion"
                 onclick="openLb(this)">
                <img src="../assets/images/poolside-pavilion.jpg" alt="Poolside Pavilion">
                <div class="gal-tile-overlay">
                    <div class="gal-tile-label">Poolside Pavilion</div>
                    <div class="gal-tile-cat">Pavilions &amp; Gathering Spaces</div>
                </div>
                <div class="gal-tile-expand"><i class="fa-solid fa-expand"></i></div>
            </div>
            <div class="gal-tile"
                ...
                <div class="gal-tile-overlay">
                    <div class="gal-tile-label">Small Bahay Kubo</div>
                    <div class="gal-tile-cat">Pavilions &amp; Gathering Spaces</div>
                </div>
                <div class="gal-tile-expand"><i class="fa-solid fa-expand"></i></div>
            </div>
        ...
        <div class="gal-masonry gal-block">
            <div class="gal-tile"
                ...
                <div class="gal-tile-overlay">
                    ...
                    <div class="gal-tile-cat">Others</div>
                </div>
                <div class="gal-tile-expand"><i class="fa-solid fa-expand"></i></div>
            </div>
            <div class="gal-tile"
