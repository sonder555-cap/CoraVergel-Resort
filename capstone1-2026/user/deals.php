...
<div class="page-body" style="margin-top:104px;">
    ...
    <section class="deals-section">
        ...
        <div style="max-width:420px; margin:0 auto; background:#fff; border-radius:12px; border:1px solid #e5e0d5; overflow:hidden;">
            <div style="position:relative;">
                <div style="position:absolute; top:12px; right:-32px; background:#c0392b; color:#fff; font-size:11px; font-weight:600; padding:4px 36px; transform:rotate(45deg);">Best Deal</div>
                <img src="../assets/images/pavilion_package.jpg" alt="Pavilion Package"
